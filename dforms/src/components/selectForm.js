...
function SelectForm({addInput}) {
    ...
    function submit(){
            addInput("select",name,placeholder,options)
            setName('')
            setPlaceholder('')
            setOptions([])    
    }
    ...
    return (
        <div>  
            <div className="mb-3">
            <label  className="form-label">Add select  </label>
            <div className="input-group mb-3">
                <span className="input-group-text" id="inputGroup-sizing-default">Select Name</span>
            ...
            <div className="input-group mb-3">
                <span className="input-group-text" id="inputGroup-sizing-default">placeholder</span>
                <input type="text" value={placeholder} name={placeholder} onChange={(e)=>setPlaceholder(e.target.value)} className="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" required />
            </div>
